...
-   Weight:  5
-   Project to be done in teams of  2  people  (your team:  Bete Gorfneh)
...
-   **Auto QA review:**  157.0/157 mandatory & 64.0/196 optional
-   **Altogether:**  **132.65%**
    -   Mandatory: 100.0%
    -   Optional: 32.65%
    -   Contribution: 100.0%
    -   Calculation: 100.0% * (100.0% + (100.0% * 32.65%) ) == **132.65%**

## Resources

**Read or watch**:

-   [Binary tree](https://alx-intranet.hbtn.io/rltoken/1F2x42-8vUbOmU4L1C1KMg "Binary tree")  (_note the first line:  `Not to be confused with B-tree.`_)
